/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 89cf5a9979964c86c5283ecbde306fb4)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	APP_ENV: "production";
	BETTER_AUTH_URL: "https://kit-hub-family-platform.scarletsilverfox.workers.dev";
	HOUSEHOLD_REALTIME: DurableObjectNamespace<import("./worker/index").HouseholdRealtime>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "HouseholdRealtime";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_URL">> {}
}
