...
export function AdminLaunchPage({onBack}:{onBack:()=>void}){
  return <main className="admin-page admin-theme-ocean admin-launch-page">
    <header className="admin-header admin-launch-page__header">
      ...
      <div className="admin-title"><span><Rocket/></span><div><small>KIT HUB PRODUCT OPS</small><h1>Pre-launch & private beta</h1><p>A separate command centre for readiness, beta households, adoption, retention and the product roadmap.</p></div></div>
