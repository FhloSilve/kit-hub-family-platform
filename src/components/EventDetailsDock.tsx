...
import { ExternalLink, LocateFixed, MapPin, Navigation, UsersRound, X } from "lucide-react";
...
export function EventDetailsDock({householdId}:{householdId:string}){
 const[eventId,setEventId]=useState<string|null>(null),[details,setDetails]=useState<Details|null>(null),[selected,setSelected]=useState<string[]>([]),[busy,setBusy]=useState(false),[error,setError]=useState(""),[memberHost,setMemberHost]=useState<HTMLElement|null>(null),[presence,setPresence]=useState<PresenceResponse|null>(null);
