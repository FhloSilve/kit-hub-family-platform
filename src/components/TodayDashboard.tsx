    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <button className="household-switcher" type="button">
          ...
          <span><strong>{householdName}</strong><small>{household?.memberCount} members</small></span>
          <ChevronDown />
        </button>
      ...
      <nav className="mobile-nav" aria-label="Mobile navigation">
        ...
        <button type="button" onClick={() => setSettingsOpen(true)} disabled={!canManageHousehold}>
      ...
      {settingsOpen && household && (
        <HouseholdSettingsModal
          ...
          onSave={async (name) => {
            ...
            const updated = await api.updateHousehold(household.id, { name });
