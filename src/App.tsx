...
export default function App(){if(isAdminPath)return <><AppearanceControl/><AdminRoute/></>;if(isDemo)return <><AppearanceControl/><StableLocalizedSurface/><PullToRefresh/><TodayDashboard bootstrap={demoBootstrap} demo onSignOut={async()=>{window.history.replaceState({},"",window.location.pathname);window.location.reload()}}/></>;return <><AppearanceControl/><StableLocalizedSurface/><PullToRefresh/><ConnectedApp/><AppUpdatePrompt/></>}
