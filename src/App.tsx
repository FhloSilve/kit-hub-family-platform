...
export default function App(){if(isAdminPath)return <AdminRoute/>;if(isDemo)return <><LocalizedSurface/><PullToRefresh/><TodayDashboard bootstrap={demoBootstrap} demo onSignOut={async()=>{window.history.replaceState({},"",window.location.pathname);window.location.reload()}}/></>;return <><LocalizedSurface/><PullToRefresh/><ConnectedApp/><AppUpdatePrompt/></>}
