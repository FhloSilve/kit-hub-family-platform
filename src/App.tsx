...
export default function App(){if(isAdminPath)return <AdminRoute/>;if(isDemo)return <><StableLocalizedSurface/><PullToRefresh/><TodayDashboard bootstrap={demoBootstrap} demo onSignOut={async()=>{window.history.replaceState({},"",window.location.pathname);window.location.reload()}}/></>;return <><StableLocalizedSurface/><PullToRefresh/><ConnectedApp/><AppUpdatePrompt/></>}
